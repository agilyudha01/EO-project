...
<body>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="search-area">
                    <form action="/search" method="get">
                        ...
                        {{-- <input type="text" class="form-control" name="search" placeholder="Masukan Nama Paket" aria-label="search" aria-describedby="basic-addon1" value="{{ request('search') }}"> --}}
                        <button type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
                    </form>
                </div>
                <!-- Favourite Area -->
                {{-- <div class="favourite-area">
                    <a href="#"><img src="{{ asset('assets/img/core-img/heart.svg') }}" alt=""></a>
                </div> --}}
                <!-- User Login Info -->
                ...
                <!-- Cart Area -->
                {{-- <div class="cart-area">
                    <a href="#" id="essenceCartBtn"><img src="{{ asset('assets/img/core-img/bag.svg') }}" alt=""> <span>3</span></a>
                </div> --}}
            </div>
    ...
    {{-- <div class="right-side-cart-area">
        ...
        <div class="cart-button">
            <a href="#" id="rightSideCart"><img src="{{ asset('assets/img/core-img/bag.svg') }}" alt=""> <span>3</span></a>
        </div>
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{ asset('assets/img/product-img/product-1.jpg') }}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{ asset('assets/img/product-img/product-2.jpg') }}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{ asset('assets/img/product-img/product-4.jpg') }}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
