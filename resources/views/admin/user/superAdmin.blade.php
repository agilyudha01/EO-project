...
<div class="container-fluid mt-3">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="page-title">Daftar Super Admin</h4>
            <a class="btn btn-success" href="{{ route('super-admin.create') }}">+ Tambah SUper Admin</a>
        </div>
    </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('super-admin.show', $user->id) }}">Lihat Detail</a></li>
                                        <li>
                                            <form action="{{ route('super-admin.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus customer ini?');">
                                                @csrf
                                                @method('DELETE')
