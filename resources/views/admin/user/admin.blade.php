...
<div class="container-fluid mt-3">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-success" href="{{ route('customer.create') }}">+ Tambah Admin</a>
        </div>
    </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('admin.show', $user->id) }}">Lihat Detail</a></li>
                                        <li>
                                            <form action="{{ route('admin.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus customer ini?');">
                                                @csrf
                                                @method('DELETE')
